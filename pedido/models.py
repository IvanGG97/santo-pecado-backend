...
class Detalle_Pedido(models.Model):
    ...
    # --- CAMPOS CORREGIDOS CON VALOR POR DEFECTO ---
    cantidad = models.PositiveIntegerField(default=0) # <-- AÑADIMOS UN VALOR POR DEFECTO
    precio_unitario = models.DecimalField(max_digits=10, decimal_places=2, default=0.00) # <-- AÑADIMOS UN VALOR POR DEFECTO
