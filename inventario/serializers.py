...
class InsumoEnRecetaSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'insumo_nombre', 'insumo_unidad', 'insumo_imagen', 'insumo_imagen_url']
...
class ProductoWriteSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Producto
        fields = [
            'tipo_producto', 'producto_nombre', 'producto_descripcion',
            'producto_precio', 'producto_disponible', 'producto_imagen', 'producto_imagen_url',
            'receta'
        ]
    ...
    def create(self, validated_data):
        ...
        if 'producto_imagen' in validated_data and validated_data.get('producto_imagen'):
            validated_data['producto_imagen_url'] = None
        elif 'producto_imagen_url' in validated_data and validated_data.get('producto_imagen_url'):
    ...
    def update(self, instance, validated_data):
        ...
        if 'producto_imagen' in validated_data and validated_data.get('producto_imagen') is not None:
            validated_data['producto_imagen_url'] = None
            instance.producto_imagen.delete(save=False)
        elif 'producto_imagen_url' in validated_data and validated_data.get('producto_imagen_url') is not None:
             validated_data['producto_imagen'] = None
             instance.producto_imagen.delete(save=False)
        elif validated_data.get('producto_imagen') is None and validated_data.get('producto_imagen_url') is None:
             if 'producto_imagen' in validated_data or 'producto_imagen_url' in validated_data:
                 instance.producto_imagen.delete(save=False)
...
class InsumoReadSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Insumo
        fields = [ 'id', 'categoria_insumo', 'insumo_nombre', 'insumo_unidad', 'insumo_stock', 'insumo_stock_minimo', 'insumo_imagen', 'insumo_imagen_url' ]
...
class InsumoWriteSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Insumo
        fields = [ 'categoria_insumo', 'insumo_nombre', 'insumo_unidad', 'insumo_stock', 'insumo_stock_minimo', 'insumo_imagen', 'insumo_imagen_url' ]
    def to_internal_value(self, data):
        mutable_data = data.copy()
    ...
    def create(self, validated_data):
        ...
        elif 'insumo_imagen_url' in validated_data and validated_data.get('insumo_imagen_url'):
             validated_data['insumo_imagen'] = None
        return super().create(validated_data)
    def update(self, instance, validated_data):
        if 'insumo_imagen' in validated_data and validated_data.get('insumo_imagen') is not None:
            validated_data['insumo_imagen_url'] = None
            instance.insumo_imagen.delete(save=False)
        elif 'insumo_imagen_url' in validated_data and validated_data.get('insumo_imagen_url') is not None:
             validated_data['insumo_imagen'] = None
             instance.insumo_imagen.delete(save=False)
        elif validated_data.get('insumo_imagen') is None and validated_data.get('insumo_imagen_url') is None:
             if 'insumo_imagen' in validated_data or 'insumo_imagen_url' in validated_data:
                 instance.insumo_imagen.delete(save=False)
